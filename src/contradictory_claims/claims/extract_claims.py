...
def load_model(MODEL_PATH:str = "https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf.tar.gz", WEIGHT_PATH:str  = "https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf_tf.th"):
...
def extract_claims(file_path: str, MODEL_PATH: str = "https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf.tar.gz", WEIGHT_PATH: str ="https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf_tf.th", col_name: str = "sentence"):
    """
