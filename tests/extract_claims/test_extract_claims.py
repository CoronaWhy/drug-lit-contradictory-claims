...
import pandas as pd
from contradictory_claims import claims
...
class TestExtractClaims(unittest.TestCase):
    ...
    def test_load_claim_extraction_model(self) -> None:
        ...
        self.model = claims.load_claim_extraction_model(model_path=MODEL_PATH, weight_path=WEIGHT_PATH)
    ...
    def test_extract_claims(self):
        ...
        df_final = claims.extract_claims(df_test, col_name="text")
