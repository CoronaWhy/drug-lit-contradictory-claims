...
def load_model(WEIGHT_PATH="https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf_tf.th": str, MODEL_PATH = "https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf.tar.gz": str):
...
def extract_claims(file_path: str, MODEL_PATH = "https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf.tar.gz": str, WEIGHT_PATH="https://s3-us-west-2.amazonaws.com/pubmed-rct/model_crf_tf.th": str):
    """
    ...
    claim_predictor=load_model(MODEL_PATH)
